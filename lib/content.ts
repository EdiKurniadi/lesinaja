...
export const MINI_TRYOUT_PACKAGES: ExamPackage[] = [
  ...
  {
    id: "mini-tiu-skd-casn",
    kind: "mini",
    title: "Mini TO TIU — SKD CASN",
    description: "35 soal verbal, numerik, dan figural paket SKD CASN standar CAT dengan pembahasan mendalam.",
    questions: MINI_TIU_4_QUESTIONS,
    durationMinutes: 35,
  },
  {
  ...
  {
    id: "mini-tiu-skd-casn-3",
    kind: "mini",
    title: "Mini TO TIU — SKD CASN Paket 3",
    description: "35 soal verbal, numerik, dan figural paket SKD CASN dengan pola logika & rumus baru serta kunci jawaban seimbang.",
    questions: MINI_TIU_6_QUESTIONS,
    durationMinutes: 35,
  },
  {
