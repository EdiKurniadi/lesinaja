        ...
        {CATEGORIES.map((category, index) => {
          ...
          return (
            <article key={category} className="border-b border-black p-5 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0 sm:p-7">
              ...
              <div className="mt-7 h-2 w-full border border-black bg-secondary"><div className="h-full bg-brand-blue transition-[width] duration-500" style={{ width: `${percentage}%` }} /></div>
