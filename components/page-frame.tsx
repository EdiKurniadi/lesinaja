  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="page-shell border-x border-black">
        ...
        {children}
        <footer className="flex flex-col gap-2 border-t border-black p-5 font-mono text-[11px] uppercase tracking-[.1em] text-muted-foreground sm:flex-row sm:justify-between sm:p-7">
