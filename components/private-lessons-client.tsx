      ...
      <section className="private-section private-teachers" id="pengajar">
        <div className="private-shell">
          ...
          <article className="private-teacher-row" data-reveal>
            ...
            <div className="private-teacher-copy"><div><p className="private-teacher-role">ASN · Pengajar TWK & TKP</p><h3>Wisnu Arsa</h3><p>Wisnu adalah ASN dan pengajar TWK–TKP dengan pengalaman lebih dari 5 tahun di berbagai bimbel. Ia terbiasa membimbing berbagai karakteristik siswa. Di kelas, TWK dibahas lewat konteks supaya nggak terasa seperti hafalan, sedangkan TKP dikupas tuntas dari alasan di balik tiap pilihan.</p></div><div className="private-tags"><span>ASN</span><span>5+ tahun mengajar</span><span>Berbagai Bimbel</span><span>TWK / TKP</span></div></div>
          </article>
          <article className="private-teacher-row" data-reveal>
            <figure className="private-teacher-photo"><Image src="/les-privat/edi-kurniadi.jpg" alt="Edi Kurniadi" width={819} height={1024} sizes="(max-width: 720px) calc(100vw - 28px), 38vw" /></figure>
            <div className="private-teacher-copy"><div><p className="private-teacher-role">ASN · Pengajar TIU</p><h3>Edi Kurniadi</h3><p>Edi adalah ASN dan pengajar TIU dengan pengalaman lebih dari 5 tahun di berbagai bimbel. Pada saat tes SKD, ia berhasil meraih skor TIU yang hampir sempurna. Di kelas, ia fokus bikin konsep terasa masuk akal dan langkah pengerjaan lebih ringkas.</p></div><div className="private-tags"><span>ASN</span><span>5+ tahun mengajar</span><span>Skor TIU Hampir Sempurna</span><span>TIU</span></div></div>
          </article>
        </div>
      </section>
